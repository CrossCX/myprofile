...
<head>
	...
	<body>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-user-account">
							...
							<li class="account-img-container">
								<img class="thumb account-img" src="<%=basePath%>catalog/plugins/wblrk/images/100/07.png" />
							</li>
		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<div class="page-heading">
					...
					<h2 class="page-title muted">
						<i class="icon-dashboard">类别管理</i>
						<i class="icon-dashboard">评论管理</i>
						<i class="icon-dashboard">添加博客</i> 
					</h2>
			...
			<ul id="sidebar" class="nav nav-pills nav-stacked">
				<li class="avatar hidden-phone">
					<a href="#">
						<img src="<%=basePath%>catalog/plugins/wblrk/images/100/06.png" />
		...
		<!-- base -->
		<script src="<%=basePath%>catalog/plugins/wblrk/assets/js/jquery.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/assets/js/bootstrap.min.js"></script>
		
		<!-- addons -->
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/chart-plugins.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jquery-ui-slider.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/redactor/redactor.min.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jmapping/markermanager.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jmapping/StyledMarker.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jmapping/jquery.metadata.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jmapping/jquery.jmapping.min.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jquery.uniform.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/chosen.jquery.min.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/bootstrap-datepicker.js"></script>
		<script src="<%=basePath%>catalog/plugins/wblrk/plugins/jquery.timePicker.min.js"></script>
				
		<!-- plugins loader -->
		<script src="<%=basePath%>catalog/plugins/wblrk/js/loader.js"></script>
	</body>
</html>